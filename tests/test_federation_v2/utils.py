...
# TODO: this graph example is incomplete.
#  Either assume this is an order service, which extended with cart service or vise versa
# TODO: or maybe event take data examples from official apollo docs
GRAPH = Graph([
    Node('Order', [
